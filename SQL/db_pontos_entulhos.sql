...
--
-- Estrutura para tabela `tb_markerphotos`
--
...
--
-- Despejando dados para a tabela `tb_markerphotos`
--
...
--
-- Estrutura para tabela `tb_markers`
--
...
--
-- Despejando dados para a tabela `tb_markers`
--
...
--
-- Restrições para tabelas `tb_markers`
--
ALTER TABLE `tb_markers`
