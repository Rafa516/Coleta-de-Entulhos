            ...
            <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                <li class="nav-item">
                    <a style="background-color: #5FB404;color: white" class="nav-link active" id="home-tab"
                        data-toggle="tab" role="tab" aria-controls="home" aria-selected="false"><b>Perfil<b></a>
                </li>
            </ul>
                ...
                <div class="row mt-5 align-items-center">
                    <div class="col-md-3 text-center mb-5">
                        <div class="avatar avatar-xl">
                            ...
                            <img src="/res/user/ft_perfil/no_photo.png" 
                                class="avatar-img rounded-circle" />
                            <?php }else{ ?>

                            <img src="/res/user/ft_perfil/<?php echo $user["picture"]; ?>" 
                                class="avatar-img rounded-circle" />
                            <?php } ?>

                            <br><br><button onclick="alertAlterarFoto()" data-toggle="modal" data-target="#imageModal" class="btn btn-primary"><b>Alterar Foto</b> </button>
                        </div>
                    </div>
                    <div class="col">
                ...
                <center><button data-toggle="modal" onclick="alertAlterarDados()" data-target="#dateModal" class="btn btn-primary"><b>Alterar Dados</b> </button></center>
                <hr class="my-4" />
                  ...
                  <div class="modal-body">
                        <form class="form-group" action="/user/profile/update/<?php echo $user["iduser"]; ?>" method="post" ><br>
                          ...
                          <div class="form-group"><label class="small mb-1"><b>Telefone</b></label>
                                  <input class="form-control py-1" value="<?php echo $user["phone"]; ?>" type="tel" name="phone"  maxlength="13" pattern="[0-9]+$" required>
                            </div>
            ...
            <div class="modal fade" id="imageModal" tabindex="-1" role="dialog" aria-labelledby="imageModal" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                        <form class="form-group" action="/user/profile/update_image/<?php echo $user["iduser"]; ?>" method="post" enctype="multipart/form-data"  ><br>
