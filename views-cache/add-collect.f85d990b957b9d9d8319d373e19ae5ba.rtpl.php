              ...
              <form class="form-group" action="/admin/add-collect/submit" method="post" enctype="multipart/form-data"><br>
                ...
                <div class="form-group"><label class="small mb-1"><b
                 ...
                 <div class="form-group"><label class="small mb-1"><b
                  ...
                  <input class="form-control py-1" placeholder="Telefone para contato" type="number" name="phone"required />
                </div>

                 <div class="form-group"><label class="small mb-1"><b
                      style="font-size:20px;color: #585858">E-mail</b></label>
                  <input class="form-control py-1" placeholder="E-mail para contato" type="email" name="email" required />
                </div>
