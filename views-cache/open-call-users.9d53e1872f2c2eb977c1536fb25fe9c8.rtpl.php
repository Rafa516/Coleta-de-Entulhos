              ...
              <div class="col">
                ...
                <div class="row mb-7">
                  <div class="col-md-7">
                    ...
                    <form class="form-group" action="/use/openCall/submit" method="post" enctype="multipart/form-data"><br>


                      <div class="form-group"><label class="small mb-1"><b style="font-size:20px;color: #585858">Local</b></label>
                        <input class="form-control py-1" type="text" name="locality" required />
                      </div>

                      <div class="form-group"><label class="small mb-1"><b style="font-size:20px;color: #585858">Observação</b></label>
                        <textarea class="form-control py-1" value="" type="text" name="observation"> </textarea>
                      </div>


                      <div class="form-group"><label class="small mb-1"><b b style="font-size:20px;color: #585858">Fotos</b></label>
                       ...
                       <input class="form-control py-1"  value="<?php echo $user["iduser"]; ?>"  name="iduser"  type="hidden">
                        ...
                        <input class="form-control py-1" id="lng" type="text" name="lat">
                     

                      <center><input style="width: 10em;" class="btn btn-primary btn " type="submit" value="Enviar"></center>
