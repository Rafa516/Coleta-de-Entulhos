            ...
            <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                <li class="nav-item">
                    <a style="background-color: #5FB404;color: white" class="nav-link active" id="home-tab"
                        data-toggle="tab" role="tab" aria-controls="home" aria-selected="false"><b>Fotos - Ponto de Entulhos,  <?php echo $markers["valueLocality"]; ?> <b></a>
                </li>
            </ul>
                ...
                <div id="myWorkContent">
                    ...
                    <?php $counter1=-1;  if( isset($images) && ( is_array($images) || $images instanceof Traversable ) && sizeof($images) ) foreach( $images as $key1 => $value1 ){ $counter1++; ?>
                      ...
                      <?php if( namePhotos($value1["idcall"]) == '' ){ ?>
                       ...
                       <a class="image-link" href="/res/ft_call/noPhoto.png"> <img style="height: 15em;width: 15em" class="photo"
                            id="image-preview" src="/res/ft_call/noPhoto.png" ></a>
