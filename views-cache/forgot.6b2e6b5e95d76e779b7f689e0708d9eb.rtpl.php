            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                      <td class="soapbox-title"><h3>Recuperação de Senha no Sistema Pontos de Entulhos</h3></td>
                    </tr>
                  ...
                  <table class="body">
                    <tr>
                      ...
                      <td class="body-padded">
                        ...
                        <![endif]--><br><center><a href="<?php echo htmlspecialchars( $link, ENT_COMPAT, 'UTF-8', FALSE ); ?>"
