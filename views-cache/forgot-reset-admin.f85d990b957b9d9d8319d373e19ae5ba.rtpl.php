...
<body>
	...
	<div class="form">
		...
		<form class="login-form" action="/admin/forgot/reset" method="post">
		...
		<?php if( $profileMsg != '' ){ ?>
			...
			<input class="user-login" type="password" name="despassword"  placeholder="Digite sua nova senha" required>
