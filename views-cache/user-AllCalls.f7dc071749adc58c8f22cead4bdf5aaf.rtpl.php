            ...
            <table class="table table-hover  table-bordered">
                ...
                <tbody>
                  ...
                  <tr style="font-size: 15px;font-weight: normal;">
                    ...
                    <td><br><center> <a style="width: 80px;" href="/user/calls/delete/<?php echo $value1["idcall"]; ?>"  onclick="return confirm('Deseja realmente excluir o registro do local: <?php echo $value1["locality"]; ?>?')" class="btn btn-danger btn-sm"> Excluir</a></td>
