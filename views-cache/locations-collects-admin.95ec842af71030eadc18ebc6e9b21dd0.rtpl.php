         ...
         <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
            <li class="nav-item">
               <a style="background-color: #088A08;color: white" class="nav-link active" id="home-tab" data-toggle="tab"
                  role="tab" aria-controls="home" aria-selected="false"><b>Pontos de Coleta -  
                   <?php if( totalCollects() == 0 ){ ?>

                          Nenhum Ponto de Coleta Registrado no Mapa
                          <?php }elseif( totalCollects() == 1 ){ ?>

                          <?php echo totalCollects(); ?> Ponto de Coleta registrado no Mapa
                          <?php }else{ ?>

                          <?php echo totalCollects(); ?> Pontos de Coleta registrados no Mapa
                          <?php } ?></b></a>
            </li>
         </ul>
