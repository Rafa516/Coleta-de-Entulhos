<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="content">
    <div class="content-inside">
        ...
        <div class="table-responsive">
            ...
            <a href="/admin/news/register" class="btn btn-primary"><b>Nova Informação</b></a>
           <div style="float: right">
                ...
                <i class="fa fa-calendar"></i> <?php echo formatDate($value1["dtregister"]); ?><br><br>

                 <h2><?php echo $value1["title"]; ?></h2><br>
                 <?php echo $value1["news"]; ?>
