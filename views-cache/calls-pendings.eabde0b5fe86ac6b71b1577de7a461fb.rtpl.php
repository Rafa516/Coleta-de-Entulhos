    ...
    <div class="content-inside">
        <div class="my-4">
                ...
                <li class="nav-item">
                    <a style="background-color: #5FB404;color: white" class="nav-link active" id="home-tab"
                        data-toggle="tab" role="tab" aria-controls="home" aria-selected="false"><b>
                          ...
                          <?php echo totalCallPendings(); ?> Chamado Pendente
                          <?php }else{ ?>

                          <?php echo totalCallPendings(); ?> Chamados Pendentes
                          <?php } ?> 
                         <b></a>
                </li>
            </ul>
            ...
            <table class="table table-hover  table-bordered">
                ...
                <tbody>
                  <?php $counter1=-1;  if( isset($callPendings) && ( is_array($callPendings) || $callPendings instanceof Traversable ) && sizeof($callPendings) ) foreach( $callPendings as $key1 => $value1 ){ $counter1++; ?>
